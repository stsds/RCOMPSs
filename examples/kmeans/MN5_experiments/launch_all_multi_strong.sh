...
wait_and_get_jobID
./launch_kmeans_RCOMPSs.sh $jobID 4 120 false 100 112 --plot FALSE --RCOMPSs --fragments 4096 --arity 64 --numpoints 1221840896 --iterations 2 --dimensions 100 --num_centres 10 --seed 2 --mode normal --Minimize
wait_and_get_jobID
./launch_kmeans_RCOMPSs.sh $jobID 8 120 false 100 112 --plot FALSE --RCOMPSs --fragments 4096 --arity 64 --numpoints 1221840896 --iterations 2 --dimensions 100 --num_centres 10 --seed 2 --mode normal --Minimize
wait_and_get_jobID
