...
for(replicate in 1:replicates){
  ...
  if(Minimize){
    ...
    cat(paste0("KNN_RES_PARALLEL,", seed, ",", n_train, ",", n_test, ",", dimensions, ",", num_class, ",", k, ",", arity, ",", confusion_matrix, ",", needs_plot, ",", Minimize, ",", Initialization_time, ",", KNN_time, ",", Total_time, ",", replicate, "\n"))
  }
  if(confusion_matrix){
