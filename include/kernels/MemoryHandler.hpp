 ...
 * All rights reserved.
 *
 * RCOMPSs GPU Memory Handler
 *
 **/

#ifndef RCOMPSs_MEMORYHANDLER_HPP
#define RCOMPSs_MEMORYHANDLER_HPP
...
namespace memory {
     ...
     *
     * @param[in] aPlacement
     * Operation placement (CPU/GPU)
     *
     * @param[in] aContext
     * Run context for GPU operations
     *
     * @return
     ...
     */
    void
    DestroyArray(char *&apArray, const gpu::OperationPlacement &aPlacement,
                 const kernels::RunContext *aContext);
     ...
     * Datatype supported: float, double
     * typename T: source datatype
     * typename X: destination datatype
     *
     * @param[in] apSource
...
#endif // RCOMPSs_MEMORYHANDLER_HPP
