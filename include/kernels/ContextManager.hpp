 ...
 * All rights reserved.
 *
 * RCOMPSs GPU ContextManager - Singleton for managing GPU contexts
 *
 **/

#ifndef RCOMPSs_CONTEXTMANAGER_HPP
#define RCOMPSs_CONTEXTMANAGER_HPP
...
namespace kernels {
    ...
    /**
     * @brief
     * Singleton Class responsible for managing and delivering all RCOMPSs Context Objects.
     */
    ...
    private:
        ...
        std::unordered_map<std::string, RunContext *> mContexts;
...
#endif // RCOMPSs_CONTEXTMANAGER_HPP
